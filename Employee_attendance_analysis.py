...
def read_attendance_data(file_path):
    """
    Reads attendance data from an Excel file and returns a DataFrame.
    Args:
        file_path (str): The path to the Excel file.
    Returns:
        pd.DataFrame: The DataFrame containing attendance data.
    """
...
def count_attendance_today(df):
    """
    Counts employees marked as WFH and WFO for the current day.
    Args:
        df (pd.DataFrame): The DataFrame containing attendance data.
    Returns:
        int, int, int: The count of WFH, WFO, and absent employees for the current day.
    """
...
def count_attendance_previous_days(df):
    """
    Counts employees marked as WFH and WFO for the previous 5 days.
    Args:
        df (pd.DataFrame): The DataFrame containing attendance data.
    Returns:
        int, int, int: The count of WFH, WFO, and absent employees for the previous 5 days.
    """
